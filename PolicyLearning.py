...
def learnPolicy(policy,dynmodel,plant,cost,fantasy,H,mu0Sim,S0Sim,M,Sigma,j):
...
#    unwrap(policy.p)
    ...
    result = scipy.optimize.minimize(po_own.targetFunc,X0,jac=po_own.targetFunc_dev,method='BFGS',options={'maxiter': 1, 'disp': False})
