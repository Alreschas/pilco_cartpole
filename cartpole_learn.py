...
class Policy:
    def __init__(self,plant,mu0,S0):
        ...
        self.param['targets'] = 0.1*np.ones([nc,len(self.maxU)])#for debug
...
def learn(j):
    ...
    learnPolicy(policy,dynmodel,plant,cost,fantasy,H,mu0Sim,S0Sim,M,Sigma,j)
    applyController(j,H,J,policy,plant,cost,mu0,S0,realCost,latent)
